...
const FaceIt = (props) => (
  <svg xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' {...props}>
    ...
    <g fill='none' fillRule='evenodd'>
      ...
      <path
        fill='#FFF'
        d='M41.5 30C50.613 30 58 37.387 58 46.5S50.613 63 41.5 63 25 55.613 25 46.5 32.387 30 41.5 30zm0 7.333a9.167 9.167 0 1 0 0 18.334 9.167 9.167 0 0 0 0-18.334zM59.5 25a3.5 3.5 0 1 1 0 7 3.5 3.5 0 0 1 0-7z'
      />
    </g>
  </svg>
)
